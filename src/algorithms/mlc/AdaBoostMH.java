...
public class AdaBoostMH extends IncludeLabelsClassifier {
	 ...
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 6524577033703649757L;

	/**
     * Default constructor
     */
    public AdaBoostMH(Classifier classifier, int n, int seed) {
        super(new AdaBoostM1(classifier, n, seed));
    }
}