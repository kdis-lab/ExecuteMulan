...
public class EnsembleOfPrunedSets extends TransformationBasedMultiLabelLearner {
    ...
    /** serialVersionUID */
	private static final long serialVersionUID = -2379118496136883354L;
	/**
     ...
     */
    public EnsembleOfPrunedSets(double aPercentage, int aNumOfModels, double aThreshold, int aP, PrunedSets.Strategy aStrategy, int aB, Classifier baselearner, boolean useConfidences, int seed) {
        super(baselearner);
        numOfModels = aNumOfModels;
        threshold = aThreshold;
        percentage = aPercentage;
