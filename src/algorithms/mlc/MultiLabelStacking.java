...
public class MultiLabelStacking extends TransformationBasedMultiLabelLearner {
     ...
     * Constructor
     */
    public MultiLabelStacking(Classifier baseClassifier, int nFolds, double ratioLabels, int seed) {
        super(baseClassifier);
        this.metaClassifier = baseClassifier;
        this.numFolds = nFolds;
        metaPercentage = ratioLabels; // use 100% of the labels in the meta-level
