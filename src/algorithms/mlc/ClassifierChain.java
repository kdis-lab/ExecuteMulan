...
public class ClassifierChain extends TransformationBasedMultiLabelLearner {
    ...
    /** serialVersionUID */
	private static final long serialVersionUID = 4496523697759949702L;
	/**
     ...
     */
    public ClassifierChain(Classifier classifier, int seed) {
        super(classifier);
    ...
    protected void buildInternal(MultiLabelInstances train) throws Exception {
        if (chain == null) {
            chain = randomChain(train.getNumLabels());
        }
     ...
     * @return Chain
     */
    protected int[] randomChain(int nLabels) {
    	int[] chain = new int[nLabels];
