...
public class EnsembleOfSubsetLearners extends MultiLabelMetaLearner {
    ...
    /** serialVersionUID */
	private static final long serialVersionUID = 7615253303036294426L;
	/**
    ...
    * @param nModels Number of models in the ensemble
    * @param nPartitions Number of random partitions to evaluate
    * @param seed Seed for random numbers
    */
    public EnsembleOfSubsetLearners(Classifier classifier, int nModels, int nPartitions, int seed) {
        this(new BinaryRelevance(classifier), classifier, new ConditionalDependenceIdentifier(classifier), nModels);
        EnsembleOfSubsetLearners.numOfRandomPartitions = nPartitions;
        this.setSeed(seed);
        rnd = new Random(seed);
    }
