...
import algorithms.mlc.EnsembleOfPrunedSets;
 ...
 *
 */
public class EPSParameters extends LearnerParameters{
	...
	protected LinkedHashMap<String, String> parameterDescription(){
		...
		map.put("r", "Sampling percentage [0, 100]. Percentage of instances to use at each PS.");
	...
	public MultiLabelLearner createObject(Parameters parameters, int seed) {
		...
		MultiLabelLearner learner = new EnsembleOfPrunedSets(
