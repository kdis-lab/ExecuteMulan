...
import algorithms.mlc.EnsembleOfBinaryRelevances;
 ...
 *
 */
public class EBRParameters extends LearnerParameters{
	...
	public MultiLabelLearner createObject(Parameters parameters, int seed) {
		...
		MultiLabelLearner learner = new EnsembleOfBinaryRelevances(
